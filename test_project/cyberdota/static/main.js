...
Vue.component('navigation', {
    template: `
            <el-menu
              ...
              <el-menu-item @click = "exit" index="4" style="font-size: 16px; color:#F56C6C"> <a class="navlink" style="text-decoration: none" href="http://127.0.0.1:8090/exit"><span>Exit</span></a></el-menu-item>
            </el-menu>
                `,
    methods: {
